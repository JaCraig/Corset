...
namespace Corset.Tests.Default
{
    public class GZipCompressorTests : TestBaseClass<GZipCompressor>
    {
        ...
        public void Compress()
        {
            ...
            Assert.Contains(Result, new string[] { "H4sIAAAAAAAACgrJyCxWAKJEhaTMEoX8NIWUxJJEhZKMxBIFT4XyxLwShZJ8heT83IKi1OJiAAAAAP//", "H4sIAAAAAAAAAgrJyCxWAKJEhaTMEoX8NIWUxJJEhZKMxBIFT4XyxLwShZJ8heT83IKi1OJiAAAAAP//" });
        }
